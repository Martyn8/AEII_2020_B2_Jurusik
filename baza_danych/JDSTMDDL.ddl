...
CREATE TABLE klient
  (
    ...
    mail              CHAR (50) ,
    telefon           INTEGER ,
    kod_weryfikacyjny INTEGER
  ) ;
ALTER TABLE klient ADD CONSTRAINT klient_PK PRIMARY KEY ( id_klienta ) ;


CREATE TABLE kod_weryfikacyjny
  (
    kod_weryfikacyjny INTEGER NOT NULL ,
    mail              CHAR (50) ,
    telefon           INTEGER
  ) ;
ALTER TABLE kod_weryfikacyjny ADD CONSTRAINT kod_weryfikacyjny_PK PRIMARY KEY ( kod_weryfikacyjny ) ;
...
ALTER TABLE sprzedawca ADD CONSTRAINT sprzedawca_PK PRIMARY KEY ( login ) ;


CREATE TABLE zarzadca
  (
    login CHAR (30) NOT NULL ,
    haslo CHAR (20) NOT NULL
  ) ;
ALTER TABLE zarzadca ADD CONSTRAINT zarzadca_PK PRIMARY KEY ( login ) ;
